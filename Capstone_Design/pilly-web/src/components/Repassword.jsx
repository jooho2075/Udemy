            ...
            <div style={{flex: 1, display: 'flex', flexDirection: 'column', backgroundColor: '#F3F0F6'}}>
                <div style={{flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 50}}>
                    ...
                    <input type="email" placeholder={idPlaceholder} onFocus={() => setIdPlaceholder("")} 
                            ...
                            style={{width: 500, height: 40, fontSize: 20, fontWeight: 'bold', padding: 10,
                                    outline: '2px solid black', marginBottom: 50, border: 'none', borderRadius: 5
                                    }}
                    />
                    <p style={{fontSize: 20, fontWeight: 'bold', color: 'black', marginBottom: 10, textAlign: 'center'}}>
                        새로운 비밀번호를 입력하세요
                    </p>
                    <input type="password" placeholder="영어 대/소문자, 특수기호 포함 8~20글자" value={newPassword}
                            onChange={(e) => setNewPassword(e.target.value)}
                            style={{width: 500, height: 40, fontSize: 20, fontWeight: 'bold', padding: 10,
                                    outline: '2px solid black', marginBottom: 10, border: 'none', borderRadius: 5
                                    }}
                    />
                    ...
                    <input type="password" placeholder="비밀번호 재입력" value={checkNewPassword}
                    ...
                    />
                    {checkNewPassword && (
                        <p style={{color: isPasswordMatch ? 'blue' : 'red', marginTop: 10}}>
