    ...
    return(
        <>
            ...
            <div style={{display: 'flex', gap: 10}}>
                ...
                <select value={year} onChange={(e) => setYear(e.target.value)} style={{padding: 5, fontSize: 20}}>
            ...
            <button type='submit' 
                    style={{marginTop: '20px', marginLeft: 40, padding: '10px 20px', width: '300px', 
                                    outline: '2px solid #F05636', borderRadius: '10px', fontWeight: 'bold',
                                    backgroundColor: '#F05636', color: 'white', marginBottom: '10px',
            ...
            <button type='submit' style={{marginTop: '20px', marginLeft: 40, padding: '10px 20px', width: '300px', 
                                        ...
                                        backgroundColor: '#2678E4', color: 'white', marginBottom: '10px',
                                        boxShadow: '1px 1px 5px rgba(0,0,0,0.2)'
                                    }}
