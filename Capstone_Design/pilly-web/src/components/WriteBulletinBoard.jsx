...
function WriteBulletinBoard() {
    ...
    return (
        <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start',
                    alignItems: 'center', minHeight: '100vh', padding: '40px', width: '100%', boxSizing: 'border-box'
                    }}
        >
            <div style={{ display: 'flex', flexDirection: 'row', marginBottom: '20px', width: '600px' }}>
                <input type="text" placeholder="제목" value={title}
                        onChange={(e) => setTitle(e.target.value)}
                        style={{marginRight: '20px', flex: 1, height: '50px',
            ...
            <input type="text" placeholder="날짜" value={new Date().toLocaleDateString()} readOnly
                    style={{marginBottom: '20px', width: '600px', height: '50px',
                            paddingLeft: '10px', border: '2px solid black', borderRadius: '5px'
                        }}
            />

            <div style={{position: 'relative', width: '600px'}}>
                <textarea ref={textareaRef} placeholder="내용" value={content} maxLength={maxContentLength}
                            onChange={(e) => setContent(e.target.value)}
                        style={{width: '100%', height: '350px', padding: '10px', fontSize: '16px',
            ...
            <div style={{width: '600px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '20px'}}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <label style={{display: 'inline-block', padding: '10px 20px', backgroundColor: '#2678E4', color: 'white',
                    ...
                    {selectedFileName && (
                        <span style={{fontSize: '14px', color: 'black', height: '40px',
                                        display: 'flex', alignItems: 'center', borderBottom: '1px solid gray', padding: '0 5px'
                                        }}
                        >
                            {selectedFileName}
                        </span>
                ...
                <button style={{height: '40px', padding: '0 20px', backgroundColor: '#2678E4', color: 'white',
